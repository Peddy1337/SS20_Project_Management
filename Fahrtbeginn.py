...
"    min-width: 200px; }")
        ...
        self.textandern = QtWidgets.QLabel(MainWindow)
        self.textandern.setGeometry(QtCore.QRect(270, 90, 200, 30))
        font = QtGui.QFont()
        font.setPointSize(17)
        self.textandern.setFont(font)
        self.textandern.setObjectName("textandern")
        self.textandern.setHidden(True)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.textandern.setText(_translate("MainWindow", "Wähle eine Art aus"))
