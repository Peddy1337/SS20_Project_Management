...
"    color: #FFFFCC;}")
        ...
        self.lineEditPin = LineEdit(self.centralwidget)
        self.lineEditPin.setGeometry(QtCore.QRect(200, 70, 265, 40))
        font = QtGui.QFont()
        font.setPointSize(20)
        self.lineEditPin.setFont(font)
        self.lineEditPin.setObjectName("lineEdit_2")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lineEditPin.setText(_translate("MainWindow", "Pin"))
